...
- Stores entries in a local SQLite database named phq9_tracker.sqlite.
...
- See BUILD_AND_RELEASE.md for folder-based executable, installer, and portable build instructions.
