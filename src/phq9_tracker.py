...
def default_db_path() -> Path:
    ...
    return APP_DIR / "phq9_tracker.sqlite"


DB_PATH = default_db_path()
BUNDLED_PYTHON = Path(r"C:\Users\Acer\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe")
...
def run_bundled_cli(args: list[str]) -> None:
    if not BUNDLED_PYTHON.exists():
        raise RuntimeError("Bundled Python runtime was not found. Use a Python environment with openpyxl, reportlab, Pillow, and pandas installed.")
